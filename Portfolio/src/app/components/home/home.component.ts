...
export class HomeComponent {
  projects: any[] = [
    ...
    {
      logo: '/assets/images/culturedLogo.png',
      title: 'Cultured',
      ...
      technologies: [
        { icon: '/assets/images/figma.png', name: 'Figma' },
      ],
      thumbnail: '/assets/images/deviceframesCultured.png',
      isDesign: true,
      github: '',
      githubUrl: ''
    },
    {
      ...
      technologies: [
        { icon: '/assets/images/angular.png', name: 'Angular' },
        { icon: '/assets/images/cSharp.png', name: 'C#' }
      ],
      thumbnail: '/assets/images/deviceframesPhonebook.png',
      isDesign: false,
      github: 'Github',
